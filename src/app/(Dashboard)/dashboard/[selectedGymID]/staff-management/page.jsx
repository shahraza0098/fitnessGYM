...
//   console.log("User role in StaffManagementPage:", role);
//   const canMark = hasPermission(role, "staff:add");
...
//             onAdd={handleAdd}
//             trigger={
//               <Button className={`flex items-center gap-2 bg-blue-600 hover:bg-blue-700 ${canMark ? '' : 'invisible'}`} disabled={!canMark}>
...
export default function StaffManagementPage({ params }) {
  ...
  const canAddStaff = hasPermission(role, "staff:add");
